  ...
  return (
    <Layout title={`${post.title} - Scylax AI Newsletter`}>
      <article className="min-h-screen">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-gray-50 to-gray-100 pt-20 pb-16">
              ...
              <div className="flex items-center justify-between pt-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">AI Security Expert</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
                    <h4 className="font-semibold mb-2">Next: Advanced AI Threat Detection</h4>
                    <p className="text-gray-600 text-sm">Learn about cutting-edge techniques for identifying AI-based attacks</p>
                  </div>
                  <div className="border rounded-lg p-6 hover:shadow-lg transition-shadow">
                    <h4 className="font-semibold mb-2">Previous: Introduction to AI Security</h4>
                    <p className="text-gray-600 text-sm">Start your journey into understanding AI security fundamentals</p>
                  </div>
                </div>
              </div>
            </div>
